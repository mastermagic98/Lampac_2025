(function() {
  ...
  */
  ...
  var hostcloud = ["https://bwa-cloud.apn.monster/online.js"];
  ...
  var framework = 'https://c73d8077.bwa.pages.dev:8443';
  ...
  if (false && Lampa.Platform.is('android') == false && Lampa.Platform.is('browser') == false) 
  {
    putcloud();
  } 
  else 
